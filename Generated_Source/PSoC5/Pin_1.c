...
/* If interrupt is connected for this Pins component */ 
    ...
    *******************************************************************************/
    void Pin_1_SetInterruptMode(uint16 position, uint16 mode)
    {
		...
		if((position & Pin_1_1_INTR) != 0u) 
		{ 
			 Pin_1_1_INTTYPE_REG = (uint8)mode; 
		} 
		if((position & Pin_1_2_INTR) != 0u) 
		{ 
			 Pin_1_2_INTTYPE_REG = (uint8)mode; 
		} 
		if((position & Pin_1_3_INTR) != 0u) 
		{ 
			 Pin_1_3_INTTYPE_REG = (uint8)mode; 
		} 
		if((position & Pin_1_4_INTR) != 0u) 
		{ 
			 Pin_1_4_INTTYPE_REG = (uint8)mode; 
		} 
		if((position & Pin_1_5_INTR) != 0u) 
		{ 
			 Pin_1_5_INTTYPE_REG = (uint8)mode; 
		}
    }
