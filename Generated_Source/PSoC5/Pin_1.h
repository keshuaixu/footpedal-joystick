...
/* Interrupt Registers */
	...
	#define Pin_1_1_INTTYPE_REG 		(* (reg8 *) Pin_1__1__INTTYPE)
	#define Pin_1_2_INTTYPE_REG 		(* (reg8 *) Pin_1__2__INTTYPE)
	#define Pin_1_3_INTTYPE_REG 		(* (reg8 *) Pin_1__3__INTTYPE)
	#define Pin_1_4_INTTYPE_REG 		(* (reg8 *) Pin_1__4__INTTYPE)
	#define Pin_1_5_INTTYPE_REG 		(* (reg8 *) Pin_1__5__INTTYPE)
#endif /* (Pin_1__INTSTAT) */
